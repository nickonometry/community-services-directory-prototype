<script>
  ...
  onMount(() => {
    let signInWidgetConfig = {
      ...
      baseUrl: 'https://dev-21900389.okta.com/oauth2/default',
      clientId: '0oaexo9c530ZUVuOj0h7',
      redirectUri: 'https://jpf.neocities.org/live-widget',
      authParams: {
        issuer: 'https://dev-21900389.okta.com/oauth2/ausexqn31sz3HMxdf0h7',
        responseType: ['id_token', 'token'],
        scopes: ['openid', 'email', 'profile']
      }
    };

    let signInWidget = new OktaSignIn(signInWidgetConfig);
    ...
    signInWidget.renderEl({ el: '#osw-container' }, widgetSuccessCallback, widgetErrorCallback);
  });
</script>
...
<svelte:head>
  ...
  <!-- Latest CDN production Javascript and CSS -->
  <!-- Latest CDN production Javascript and CSS -->
  <script src="https://global.oktacdn.com/okta-signin-widget/7.14.1/js/okta-sign-in.min.js" type="text/javascript"></script>
  <link href="https://global.oktacdn.com/okta-signin-widget/7.14.1/css/okta-sign-in.min.css" type="text/css" rel="stylesheet" />
</svelte:head>
